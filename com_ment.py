...
def plot_func(a_value): #отдельно реализовали функцию вычисления значения относительно каждого элемента массива arguments, рассчитывая на масштабируемость программы
